"""happy_tap_19650 URL Configuration
...
admin.site.site_header = "Happy Tap"
admin.site.site_title = "Happy Tap Admin Portal"
admin.site.index_title = "Happy Tap Admin"

# swagger
api_info = openapi.Info(
    title="Happy Tap API",
    default_version="v1",
    description="API documentation for Happy Tap App",
)
